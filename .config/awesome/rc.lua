...
function UpdateXBL()
	local ntime = os.clock() + 0.3
	repeat until os.clock() > ntime
	local f = io.popen("xbacklight")
	local res = f:read("*a")
	f:close()
	local xbl = res:match("(%d+).%d+")

	myxblwidget:set_text("XBL: " .. xbl)
end
UpdateVOL()
UpdateXBL()
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
			...
			-- coinwidget({ timeout = 15 }),
			-- seperator,
			-- coinwidget({ timeout = 15, symbol = "ETHUSDT", short = "ETH", prec = 2 }),
			-- seperator,
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift", "Control", "Alt" }, "BackSpace", awesome.quit,
    ...
    -- Dmenu
    awful.key({ modkey }, "d", function() awful.util.spawn("dmenu_run -p 'Run command' "
														.. " -nb '" .. string.sub(beautiful.bg_normal, 1, 7) .. "'"
														.. " -nf '" .. beautiful.fg_normal .. "'"
														.. " -sb '" .. beautiful.bg_focus .. "'"
														.. " -sf '" .. beautiful.fg_focus .. "'") end,
              { description = "show dmenu", group = "launcher" }),
    -- Adjust Brightness
    awful.key({ }, "XF86MonBrightnessDown", function() awful.util.spawn("xbacklight -dec 1") UpdateXBL() end),
    awful.key({ }, "XF86MonBrightnessUp", function() awful.util.spawn("xbacklight -inc 1") UpdateXBL() end),
	-- Adjust sound
    awful.key({ }, "XF86AudioMute", function() awful.util.spawn("amixer sset Master toggle") UpdateVOL() end),
    awful.key({ }, "XF86AudioRaiseVolume", function() awful.util.spawn("amixer sset Master 5%+") UpdateVOL() end),
    awful.key({ }, "XF86AudioLowerVolume", function() awful.util.spawn("amixer sset Master 5%-") UpdateVOL() end),
	-- Screenshot
